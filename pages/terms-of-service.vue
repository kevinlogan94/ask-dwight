  ...
  <div class="flex flex-col items-center justify-center p-24 min-h-screen">
    <UPageCard class="w-full max-w-4xl">
      <div class="prose dark:prose-invert max-w-none">
        ...
        <p>
          Welcome to ask-dwight.com and its subdomains. These Terms of Service ("Terms") govern your access to and use
          of ask-dwight.com and all its subdomains, including app.ask-dwight.com (collectively, the "Service"). By
        ...
        <p>
          The Service provides an AI-powered sales assistant designed to help users improve their sales processes and
          outcomes. The Service includes features such as sales conversation analysis, recommendations, and related
          functionalities.
        </p>

        <h2>3. User Accounts</h2>
        <p>
          To access certain features of the Service, you must create an account using Google authentication. You are
          responsible for maintaining the confidentiality of your account and for all activities that occur under your
          account. You agree to:
        </p>
        <ul>
          <li>Provide accurate and complete information when creating your account</li>
          <li>Update your account information as necessary to maintain its accuracy</li>
          <li>Immediately notify us of any unauthorized use of your account or any other breach of security</li>
        </ul>

        <h2>4. User Content</h2>
        <p>
          You retain ownership of any content you submit, upload, or display on or through the Service ("User Content").
          By submitting User Content, you grant us a worldwide, non-exclusive, royalty-free license to use, copy,
          modify, create derivative works based on, distribute, publicly display, and publicly perform your User Content
        ...
        <ul>
          ...
          <li>
            Use the Service for any purpose that is harmful, threatening, abusive, harassing, defamatory, or otherwise
            objectionable
          </li>
          <li>
        ...
        <p>
          The Service and its original content, features, and functionality are owned by Ask-Dwight, LLC and are
        ...
        <p>
          In no event shall Ask-Dwight, LLC, its officers, directors, employees, or agents, be liable to you for any
...
useHead({
  ...
  meta: [{ name: "description", content: "Terms of Service for ask-dwight.com and all subdomains" }],
});
</script>
